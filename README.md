...
| [programming](./programming) | 综合题目 | 已按算法思想分组的双指针、二分、图搜索、动态规划、贪心等题目，并包含补充题和 GPLT 练习 |
...
- 埃氏筛、匹配子序列数量、多轮筛选、安全格子统计、相反数对统计、窗口点击模拟、GPLT 2026 赛题练习、栈辅助序列构造、堆栈计算器、老板空闲时间、外卖路径统计、最佳异性缘筛选、养老院管理统计、吃火锅文本检索、刮彩票等扩展题
